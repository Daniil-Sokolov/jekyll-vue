...
module Jekyll
  ...
  class Picture < Liquid::Tag
    ...
    def render(context)
      ...
      raise "Picture Tag can't find this preset source. Check picture: presets: #{markup[:preset]} in _config.yml for a list of sources." unless (source_src.keys - source_keys) != nil#.empty?
